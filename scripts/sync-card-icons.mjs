...
const versionFile = path.join(ROOT, "../apps/web/src/icon-version.ts");
fs.writeFileSync(
  versionFile,
  `/** auto-generated by scripts/sync-card-icons.mjs */\nexport const ICON_VERSION = ${JSON.stringify(String(Date.now()))};\n`,
);
console.log(`icon-version.ts updated`);
